...
public class Message implements Comparable<Message> {
	...
	private String[] coded_id;
	private int[] coding_coefficients;
	private double[] creation_times;
	static {
		reset();
...
//		}
	...
	public void setHops(List<DTNHost> path) {
		this.path = path;
	}
	...
	public double[] getCreation_times() {
		return this.creation_times;
	}

	public void setCreation_times(double[] creation_times) {
	...
	protected void copyFrom(Message m) {
		...
		this.appID = m.appID;
		this.coded = m.is_coded();
		this.coded_id = m.getCodedid();
		this.coding_coefficients = m.getCoding_Coef();
		this.payload = m.getPayload();
		this.generation = m.getGeneration();
		this.creation_times = m.getCreation_times();
	...
	public boolean is_coded() {
		return coded;
	}

	public void setCoded() {
		this.coded = true;
	}

	public void setUnCoded() {
		this.coded = false;
	}
	...
	public void setCodedId(String[] coded_id) {
		this.coded_id = coded_id;
	}

	public void setCoding_Coef(int[] coding_coefficients) {
		this.coding_coefficients = coding_coefficients;
	}

	public int[] getCoding_Coef() {
		return coding_coefficients;
	}

	public int getGeneration() {
		if (!coded) {
			StringTokenizer st = new StringTokenizer(id, "M");
			int gener = (int) Integer.parseInt(st.nextToken()) /5;
			return gener;
		} else {
			return generation;
		}
