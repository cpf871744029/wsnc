...
public class DTNHost implements Comparable<DTNHost> {
	...
	public DTNHost(List<MessageListener> msgLs,
			...
			MovementModel mmProto, MessageRouter mRouterProto,boolean tanslate) {
		this.comBus = comBus;
		...
		this.location = movement.getInitialLocation(tanslate);	
		if(groupId.equals("F")){
			this.location.setLocation(8000,8000);
		}
