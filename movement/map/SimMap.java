...
public class SimMap implements Serializable {
	...
	private ArrayList<MapNode> hotNodes;/*changed by chen*/
	...
	public SimMap(Map<Coord, MapNode> nodes) {
		...
		this.hotNodes = new ArrayList<MapNode>();
		setBounds();
	}
	...
	/*changed by chen*/
	public void addHotNodes(Coord c){
		hotNodes.add(this.getNodeByCoord(c));
	}
	/*changed by chen*/
	public ArrayList<MapNode> getHotNodes(){
		return  hotNodes;
	}
	/**
